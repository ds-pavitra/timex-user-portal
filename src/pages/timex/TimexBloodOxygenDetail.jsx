...
const trendOptions = {
    ...
    yaxis: { min: 80, max: 100, labels: { style: { colors: '#91a1b6', fontSize: '10px' } } },
    grid: { borderColor: 'rgba(0,0,0,0.08)', strokeDashArray: 3, padding: { left: 4, right: 4 } },
    tooltip: { theme: 'light', style: { fontSize: '11px' }, y: { formatter: v => `${v}%` } },
    dataLabels: { enabled: false },
    legend: { show: false },
}
const trendSeries = [{ name: 'SpO2', data: [96, 77, 100, 67, 85, 90, 80] }]

const HISTORY = [
    { date: '30 Jan 2025  3:00 PM', value: '80%' },
    { date: '30 Jan 2025  3:00 PM', value: '90%' },
    { date: '30 Jan 2025  4:27 PM', value: '85%' },
]

const SPO2_ZONES = [
    {
        label: 'Critical', range: 'Below 85%', color: '#d13b4c',
        insight: 'Your oxygen levels are severely depleted, compromising how your organs function. This requires immediate attention outside of a clinical setting.',
        when: 'Severe respiratory distress or medical emergencies.',
    },
    {
        label: 'Very Low', range: '85–89%', color: '#e49e3d',
        insight: 'Your body is experiencing a significant decrease in oxygen, which can cause noticeable fatigue or breathlessness.',
        when: 'Extreme altitude exposure or underlying respiratory challenges.',
    },
    {
        label: 'Low', range: '90–94%', color: '#e4c93d',
        insight: 'Your oxygen saturation is slightly reduced, potentially causing a subtle dip in endurance or energy.',
        when: 'Adjusting to high altitudes or recovering from a mild respiratory bug.',
    },
    {
        label: 'Normal', range: '95–97%', color: '#25b865',
        insight: 'Your oxygen levels are healthy and balanced, providing strong support for everyday life.',
        when: 'Standard daily activities and light exercise.',
    },
    {
        label: 'Optimal', range: '98–100%', color: '#25b865',
        insight: 'Your body is highly oxygenated, supporting peak cellular performance, rapid recovery, and sustained energy.',
        when: 'Deep, relaxed breathing and overall excellent cardiovascular fitness.',
    },
]

const RangeBar = ({ value = 98 }) => {
        ...
        <div style={{ paddingTop: 22, paddingBottom: 4 }}>
            <div style={{ position: 'relative' }}>
                ...
                <div style={{
                    ...
                    background: 'linear-gradient(90deg,#d13b4c 0%,#e49e3d 30%,#e4c93d 55%,#25b865 100%)',
                    position: 'relative'
                }}>
                    <div style={{
        ...
        <>
            <div className="page-header">
                <div className="page-header-left d-flex align-items-center gap-3">
                    ...
                    <div>
                        <h5 className="fw-bold text-dark mb-0">Blood Oxygen</h5>
            ...
            <div className="main-content">
                <div className="row g-3">
                            ...
                            <div className="card-body">
                                ...
                                <div className="d-flex align-items-center justify-content-between mb-3">
                                    <div className="d-flex align-items-baseline gap-2">
                                        <span className="fw-bolder text-info" style={{ fontSize: 52 }}>98</span>
                                        <span className="fs-14 text-muted">%</span>
                                    </div>
                                    <FiDroplet size={36} className="text-info opacity-25" />
                                </div>
                                <p className="fs-12 text-muted mb-2">Your Blood Oxygen range is:</p>
                        ...
                        <div className="card stretch stretch-full">
                            <div className="card-header">
                                ...
                                <div className="d-flex gap-2">
                                    <span className="badge bg-soft-info text-info">Min 67%</span>
                                    <span className="badge bg-soft-info text-info">Max 100%</span>
                                </div>
                            </div>
                    ...
                    <div className="col-12 col-md-6">
                        <div className="card stretch stretch-full">
                            <div className="card-header">
                                <h5 className="card-title mb-0">SpO2 Readings — History</h5>
                            </div>
                            <div className="card-body">
                                ...
                                {HISTORY.map((h, i) => (
                                    <div key={i} className="d-flex justify-content-between align-items-center py-3 border-bottom">
                                        ...
                                        <span className="fs-14 fw-semibold text-info">{h.value}</span>
                                    </div>
                                ))}
                            </div>
                        </div>
                    ...
                    <div className="col-12 col-md-6">
                        <div className="card stretch stretch-full">
                            <div className="card-header">
                                <h5 className="card-title mb-0">Blood Oxygen Zones</h5>
                            </div>
                            <div className="card-body">
                                <p className="fs-12 text-muted mb-4">
                                    Your blood oxygen level reflects how well your body distributes oxygen from your lungs to your cells. Maintaining healthy levels is essential for your energy, focus, and overall vitality.
                                </p>
                                {SPO2_ZONES.map(z => (
...
export default TimexBloodOxygenDetail
